"""
AgroPlanificación — Tablero Ganadero
...
st.set_page_config(
    page_title="AgroPlanificación — Tablero Ganadero",
    page_icon="🐄",
    layout="wide",
...
_NAV_ITEMS: list[tuple[str, str]] = [
    ...
    ("Recomendación Estratégica", "lightbulb-fill"),
...
_PAGES: dict = {
    ...
    "Recomendación Estratégica": page_recomendacion.render,
            ...
            <div style="display:flex;align-items:center;gap:12px;">
                ...
                <div>
                    <div style="font-size:1.06rem;font-weight:700;color:#ddeeff;
                                letter-spacing:-0.01em;line-height:1.2;">AgroPlanificación</div>
